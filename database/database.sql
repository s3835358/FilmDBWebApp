...
-- Dumping data for table core.account: ~1 rows (approximately)
...
INSERT INTO `show` (`showid`, `show_title`, `genre`, `length`, `movie`, `series`, `proco_id`, `year`) VALUES
(1, 'Star Wars: Episode IX - The Rise of Skywalker', 'Action', 2.22, 1, 0, 9, 2019);
